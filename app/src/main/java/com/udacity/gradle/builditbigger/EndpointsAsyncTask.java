...
import com.example.jokeandroid.MainActivityLibraryAndroid;
...
//Código consultado no link abaixo, para auxilio na implementação do AsyncTask.
...
public class EndpointsAsyncTask extends AsyncTask<Context,Void, String>{
    ...
    protected void onPostExecute(String result) {
        final Intent intent = new Intent(context, MainActivityLibraryAndroid.class);
